...
-- 用户表初始数据
INSERT INTO user (user_account, user_password, union_id, mp_open_id, user_name, user_avatar, user_profile, user_role,
                  create_time, update_time, is_delete)
VALUES ('yupi', 'b0dd3697a192885d7c055db46155b26a', null, null, '鱼皮',
...
-- 应用表初始数据
INSERT INTO app (id, app_name, app_desc, app_icon, app_type, scoring_strategy, review_status, review_message, reviewer_id,
...
-- 评分结果表初始数据
INSERT INTO scoring_result (id, result_name, result_desc, result_picture, result_prop, result_score_range, create_time,
                            update_time, is_delete, app_id, user_id)
...
-- 用户回答表初始数据
INSERT INTO user_answer (id, app_id, app_type, choices, result_id, result_name, result_desc, result_picture, result_score,
                         scoring_strategy, user_id, create_time, update_time, is_delete)
